...
// copied from https://docs.microsoft.com/en-us/windows/win32/direct3d11/overviews-direct3d-11-resources-textures-how-to
...
//-------------------------------------------------------------------------------------
	...
	private:
		ScopedObject(const ScopedObject&) = default;
		ScopedObject& operator=(const ScopedObject&) = default;
...
namespace DXF::WicTextureFactory
{
	...
	{
		IWICImagingFactory* pWicFactory = GetWIC();
		if (!pWicFactory)
			return E_NOINTERFACE;

		ScopedObject<IWICBitmapDecoder> decoder;
		HRESULT hr = pWicFactory->CreateDecoderFromFilename(filename.c_str(), 0, GENERIC_READ, WICDecodeMetadataCacheOnDemand, &decoder);
		if (FAILED(hr))
			return hr;
